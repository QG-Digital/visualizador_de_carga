    ...
    if (calculatorWorker) {
        calculatorWorker.onmessage = function(e) {
            ...
            if (type === 'progress') {
                ...
                // Os dados 'status' e 'truckStatus' chegam como Arrays.
                // Precisamos convertê-los de volta para Maps para que o resto do código funcione.
                lastCalculationData = {
                    placedItems: data.placedItems,
                    unplacedItems: data.unplacedItems,
                    status: new Map(data.status), // Convertendo o array de status de volta para um Map
                    truckStatus: new Map(data.truckStatus) // Convertendo o array de truckStatus de volta para um Map
                };
                ...
                // Agora que 'status' é um Map, este código funciona corretamente.
